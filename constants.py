...
NEW_GAME_BUTTON_POS_X = SCREEN_WIDTH / 3
NEW_GAME_BUTTON_POS_Y = BOARD_MARGIN + BOARD_LENGTH + MENU_HEIGHT / 2
AI_MODE_BUTTON_POS_X = 2*SCREEN_WIDTH / 3
AI_MODE_BUTTON_POS_Y = NEW_GAME_BUTTON_POS_Y

TILE_SPEED = 30  # pixels per frame
PERCENTAGE_NEW_TILE_IS_TWO = .89
